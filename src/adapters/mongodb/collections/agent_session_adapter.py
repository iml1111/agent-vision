"""
Agent Session Collection Adapter
"""
from typing import Optional, Dict, Any, List
from ..base import BaseMongoAdapter


class AgentSessionAdapter(BaseMongoAdapter):
    """Adapter for AgentSession collection"""

    collection_name = "AgentSession"
    ...
    async def find_many(
        ...
        """Find multiple session documents"""
    ...
    async def delete_one(self, filter_dict: Dict[str, Any]):
        """Delete single session document"""
